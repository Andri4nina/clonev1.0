...
<section class=" block max-w-6xl w-full mx-auto ">
    <div class=" relative usersection">
        <h3 class="bounceslideInFromLeft text-2xl pl-2 mb-5 font-semibold">        <a href="{{ route('membre.index') }}"  ><i class="text-4xl bx bx-chevron-left"></i></a> Membre / <small>Creation</small></h3>
                ...
                <div class=" p-5 crud-card">
                    ...
                    <div class="my-5 flex justify-center items-center">
                        <div class="relative h-20 w-20">
                            <img src="{{ asset('images/sans-image/nopdp.png') }}" alt="" id="membre-pdp" class=" h-full w-full border border-gray-600 rounded-full nopdpimg">
