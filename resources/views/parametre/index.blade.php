...
@endif
    <div class="usersection">
        ...
        <form action="{{ route('parametre.update') }}" method='POST' enctype="multipart/form-data">
            ...
            @endif
            <div class="bounceslideInFromLeft mx-auto w-full sm:w-2/3 flex justify-center items-center gap-8 parametre-card">
            ...
            <div class="bounceslideInFromRight mx-auto my-5 w-full sm:w-2/3 parametre-card">
