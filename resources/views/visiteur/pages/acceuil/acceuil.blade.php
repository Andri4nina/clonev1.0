    ...
    <div class="overflow-x-hidden w-full flex flex-col gap-5 lg:flex-row">
        <div class="mx-0 lg:mx-5 mb-5 w-full lg:w-1/4 ">
            ...
            <div class="w-full my-5 flex justify-center">
                <a href="#" class="text-blue-500 text-right">Tous voir <i class="bx bx-arrow-from-right"></i></a>
            </div>
        ...
        <div class="mx-0 lg:mx-5 w-full lg:w-1/4">
            ...
            <div class="w-full text-center my-5 ">
                <a href="{{ route('public.about') }}" class="text-blue-500 text-right">Plus de details <i class="bx bx-arrow-from-right"></i></a>
