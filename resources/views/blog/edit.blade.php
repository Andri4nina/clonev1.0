...
<section class=" block w-10/12 mx-auto ">
    <div class="relative usersection">
        <h3 class="text-base pl-2 mb-5">Blogs / Modification</h3>
                ...
                <div class="w-1/2 p-5 crud-card">
                    ...
                    <div class=" mb-5 flex flex-wrap gap-1"  id="photosContainer">
                        ...
                        @foreach ($photos as $photo )
                            <div class="w-3/12 h-32 relative rounded-lg input-field phote-add">
                                <div class="w-full h-full">
                                    <img src="{{ asset($photo->img) }}" alt="" class="w-full h-full object-contain">
                                </div>
                                <div class="hidden">
                                    <input type="file" name="photo1" style="display: none;" value="{{ $photo->img }}">
                                </div>
                                <div class="absolute top-0 right-0 closerphoto">
