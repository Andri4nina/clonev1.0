...
<section class=" block max-w-6xl w-full mx-auto ">
    <div class="relative usersection">
        <h3 class="bounceslideInFromLeft text-2xl pl-2 mb-5 font-semibold">        <a href="{{ route('partenaire.index') }}"  ><i class="text-4xl bx bx-chevron-left"></i></a> Partenaires / <small>Creation</small></h3>
            ...
            <div class="mx-auto block md:flex max-w-5xl gap-2">
                ...
                <div class="bounceslideInFromRight w-full mt-5 md:mt-0  md:w-1/2 p-5 crud-card">
                    ...
                    <div class="relative mb-5 w-full h-64">
                        <img src="" alt="" class="object-cover w-full h-full partenaire-logo-preview nopdpimg">
                    </div>
                    <div class="">
